...
# Filter for ribosomal proteins and eukaryotic initiation and elongation factors --------
...
#save heatmap
ggsave(plot = heatmap_translation_v2, here::here('figures/figure_6/heatmap_translation.pdf'), height = 60, width = 150, units = "mm")
